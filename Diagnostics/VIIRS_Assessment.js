...
// ------------- START OF LOOP ---------------
var mcd64a1_Commission = []; var mod2sat_Commission = [];
var mcd64a1_Omission = []; var mod2sat_Omission = [];
for(var iYear = sYear; iYear <= eYear; iYear++) {
  ...
  // Mod2Sat BA
  var mod2satYr = ee.Image(mod2sat.clip(Shp)).gt(1).selfMask();
  Map.addLayer(mod2satYr,{palette:"blue"}, "MOD2SAT")
  ...
  Map.addLayer(mcd64a1Yr,{palette:"Red"}, "MCD64A1")
  ...
  print("VIIRS Total:",viirsPts.size())
  ...
  print(mcd64a1Yr_Commission)
  
  mod2sat_Omission = ee.FeatureCollection(mod2sat_Omission).merge(mod2satYr_Omission);
